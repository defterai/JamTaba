...
HEADERS += audio/IntervalUtils.h
HEADERS += controller/AudioController.h
HEADERS += controller/AudioEncoderController.h
...
HEADERS += persistence/SettingsObject.h
HEADERS += persistence/AudioSettings.h
HEADERS += persistence/WindowSettings.h
HEADERS += persistence/MetronomeSettings.h
HEADERS += persistence/VstSettings.h
HEADERS += persistence/MultiTrackRecordingSettings.h
HEADERS += persistence/LocalInputTrackSettings.h
HEADERS += persistence/PrivateServerSettings.h
HEADERS += persistence/MeteringSettings.h
HEADERS += persistence/LooperSettings.h
HEADERS += persistence/RememberSettings.h
HEADERS += persistence/CollapseSettings.h
...
mac:HEADERS += persistence/AudioUnitSettings.h
...
SOURCES += controller/AudioController.cpp
SOURCES += controller/AudioEncoderController.cpp
...
mac:SOURCES += persistence/AudioUnitSettings.cpp
...
SOURCES += persistence/SettingsObject.cpp
SOURCES += persistence/AudioSettings.cpp
SOURCES += persistence/WindowSettings.cpp
SOURCES += persistence/MetronomeSettings.cpp
SOURCES += persistence/VstSettings.cpp
SOURCES += persistence/MultiTrackRecordingSettings.cpp
SOURCES += persistence/LocalInputTrackSettings.cpp
SOURCES += persistence/PrivateServerSettings.cpp
SOURCES += persistence/MeteringSettings.cpp
SOURCES += persistence/LooperSettings.cpp
SOURCES += persistence/RememberSettings.cpp
SOURCES += persistence/CollapseSettings.cpp
